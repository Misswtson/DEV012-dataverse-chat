export default [ //colocarle comillas a las claves
    ...
    },
    {
      ...
      shortDescription:
        "Embárcate en un viaje mágico con dos niñas que encuentran amistad y maravillas en el bosque con el encantador Totoro",
      description:
      ...
      imageUrl:
        "https://i.kinja-img.com/image/upload/c_fit,q_60,w_645/ijmuciy2p6cg6tp6bqab.jpg",
      facts: {
        year: 1988,
        genre: "Fantasía",
    ...
    },
    {
      ...
      name: "Porco Rosso",
      shortDescription:
        "Únete al valiente piloto Porco Rosso mientras desafía a piratas aéreos en la Adriática de la década de 1930.",
      description:
    ...
    },
    {
      ...
      shortDescription:
        "Acompaña a una joven en su inspirador viaje de autodescubrimiento y creatividad mientras persigue su pasión por la escritura.",
      description:
    ...
    },
    {
      ...
      name: "Paprika",
      shortDescription:
        "Adéntrate en un mundo de sueños y pesadillas cuando una terapeuta usa tecnología para explorar la psique de sus pacientes.",
      description:
    ...
    },
    {
      ...
      name: "Spirited Away",
      shortDescription:
        "Acompaña a Chihiro en un viaje mágico a un mundo espiritual donde supera desafíos y descubre su coraje interior.",
      description:
    ...
    },
    {
      ...
      shortDescription:
        "Explora una conmovedora fábula de una princesa celestial que lucha contra expectativas y celebra la belleza de la vida humana.",
      description:
    ...
    },
    {
      ...
      shortDescription:
        "Acompaña a una joven bruja en su encantador viaje de autodescubrimiento mientras abre un servicio de entregas mágicas.",
      description:
    ...
    },
    {
      ...
      name: "The Red Turtle",
      shortDescription:
        "Sumérgete en una historia silente y emotiva de un náufrago que forja un vínculo profundo con una misteriosa tortuga roja.",
      description:
    ...
    },
    {
      ...
      shortDescription:
        "En un mundo donde la lluvia es mágica, dos jóvenes buscan un amor imposible bajo los cielos cambiantes.",
      description:
